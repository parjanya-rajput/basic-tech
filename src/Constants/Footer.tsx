...
<YoutubeIcon size={24} />
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-600 hover:text-gray-900">Past Project</a></li>
              <li><a href="#" className="text-gray-600 hover:text-gray-900">Case Study</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:contact@company.com" className="text-gray-600 hover:text-gray-900">contact@company.com</a>
              </li>
              <li className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className="text-gray-600">794 Mcallister St<br />San Francisco, 94102</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 mt-8 border-t border-gray-200">
          <p className="text-gray-600 text-sm text-right">
            All Rights Reserved | <a href="#" className="text-blue-600 hover:underline">Terms and Conditions</a> | <a href="#" className="text-blue-600 hover:underline">Privacy Policy</a>
          </p>
        </div>
      </div>
    </footer>
