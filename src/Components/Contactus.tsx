...
export const Contactus = () => {
  ...
  return (
    ...
    <h2 className="text-2xl font-bold text-center text-blue-600 mb-6">Connect with us</h2>
    ...
    <div className="bg-white/80 rounded-lg shadow-md p-6 md:p-8 mb-10">
      <div className="flex flex-col md:flex-row">
        ...
        <iframe name="hiddenFrame" style={{display: "none"}}></iframe>
          <form target='hiddenFrame' action={'https://docs.google.com/forms/u/0/d/e/1FAIpQLSfX9B7G9FbEta72nTyhK3B8aBON_REhfHw_Y0VEmP0hVDn5AQ/formResponse'} method='POST' onSubmit={handleSubmit} className="space-y-4">
