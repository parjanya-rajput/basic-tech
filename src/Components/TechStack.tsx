...
const images=[Image0,Image1,Image2,Image3,Image4,Image5,Image6,Image7,Image8,Image9,Image10,Image11,Image12,Image13,Image14,Image15,Image16,Image17,Image18,Image19,Image20]
const TechStackPage = () => {
  ...
  const techIcons = [
    ...
    { name: 'Node.js', color: 'bg-pink-500' },
    { name: 'Firebase', color: 'bg-orange-500' },
    { name: 'MongoDB', color: 'bg-green-500' },
    { name: 'PostgreSQL', color: 'bg-blue-600' },
    { name: 'PHP SQL', color: 'bg-blue-400' },
    ...
    <div className=" relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="bg-white/50 rounded-lg shadow-md p-8 mb-10">
          <h2 className="text-2xl font-bold text-center text-blue-600 mb-8">Techstack</h2>
          
          <div className="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-7 gap-6 justify-items-center">
            {images.map((tech, index) => (
              <div key={index} className="flex flex-col items-center">
                <img src={tech} className={` rounded-full  flex items-center justify-center text-white text-xl mb-2 hover:scale-105`} />
