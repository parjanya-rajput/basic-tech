...
const PastProjects = () => {
  ...
  return (
    <section className="py-10 bg-gradient-to-b from-blue-100 to-green-100 p-4">
      <h2 className="text-center text-2xl font-bold text-blue-600">Past Projects</h2>
      <div className="max-w-3xl mx-auto mt-6 flex flex-col gap-10">
        {/* First Project with Full Background Image */}
        {projects.map((project, index) => (
                    <div onClick={() => {navigate("/projects", { state: { project } });window.scrollTo({ top: 0, behavior: "smooth" });}}
